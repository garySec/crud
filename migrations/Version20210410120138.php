 ...
 */
final class Version20210410120138 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE request_save (id INT AUTO_INCREMENT NOT NULL, url VARCHAR(255) NOT NULL, params LONGTEXT NOT NULL, method VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    }
