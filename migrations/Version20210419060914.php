 ...
 */
final class Version20210419060914 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE user_data_user_hobbie (user_data_id INT NOT NULL, user_hobbie_id INT NOT NULL, INDEX IDX_FA1BAF5D6FF8BF36 (user_data_id), INDEX IDX_FA1BAF5D5056F553 (user_hobbie_id), PRIMARY KEY(user_data_id, user_hobbie_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE user_hobbie (id INT AUTO_INCREMENT NOT NULL, hobbie VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE user_data_user_hobbie ADD CONSTRAINT FK_FA1BAF5D6FF8BF36 FOREIGN KEY (user_data_id) REFERENCES user_data (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE user_data_user_hobbie ADD CONSTRAINT FK_FA1BAF5D5056F553 FOREIGN KEY (user_hobbie_id) REFERENCES user_hobbie (id) ON DELETE CASCADE');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user_data_user_hobbie DROP FOREIGN KEY FK_FA1BAF5D6FF8BF36');
        $this->addSql('ALTER TABLE user_data_user_hobbie DROP FOREIGN KEY FK_FA1BAF5D5056F553');
        ...
        $this->addSql('DROP TABLE user_data_user_hobbie');
        $this->addSql('DROP TABLE user_hobbie');
