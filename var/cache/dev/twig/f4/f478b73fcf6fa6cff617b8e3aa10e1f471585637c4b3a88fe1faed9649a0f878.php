...
class __TwigTemplate_0de958300d9757686251a0d9de2b8ee8ba68c13c9794054618bd35c6a844cd29 extends Template
{
    ...
    <a href=\"";
        ...
        echo "\"><button class=\"btn btn-lg btn-primary mb-3\" type=\"submit\">Register</button></a>
";
...
<form method=\"post\">
    ...
    <a href=\"{{path('register')}}\"><button class=\"btn btn-lg btn-primary mb-3\" type=\"submit\">Register</button></a>
{% endblock %}
", "security/login.html.twig", "/var/www/html/php/sfny/templates/security/login.html.twig");
    }
}
