...
class __TwigTemplate_ffc0778d1e4ea863a6f5006928f7390dcb3d9a34501e4725e2e44771ac1a77b2 extends Template
{
    private $source;
    private $macros = [];
...
{% block body %}
{{ form(form) }}
{# <a href=\"{{ path(register)}}\"><button class=\"btn btn-success\">Register</button></a> #}
{% endblock %}
", "register/index.html.twig", "/var/www/html/php/sfny/templates/register/index.html.twig");
    }
}
